...
const MusicNavbar = props => {
    ...
    return(
        <div className={props.className}>
            <NavbarTabs setActive={setActive} active={active} left={<MusicFileInput active={leftActive}/>} right={<InteravlTabIcon active={rightActive}/>}/>
            {active === "left" ? <MusicList/> : <IntervalList/>}
        </div>
    )
}
